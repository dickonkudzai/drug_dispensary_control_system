...
<section class="content">
      <div class="row">
       ...
       $result = mysql_query("SELECT * FROM cashier")or die(mysql_error());
        ...
        while($row = mysql_fetch_array( $result )) {
            ...
            echo "<tbody>";
                ...
                ?>
                <td><a href="update_cashier.php?username=<?php echo $row['username']?>"><span class="glyphicon glyphicon-new-window"></span></td>
                <td><a href="delete_cashier.php?cashier_id=<?php echo $row['cashier_id']?>"><span class="glyphicon glyphicon-trash"></span></td></tr></tbody>
                <?php
         } 
        // close table>
        echo "</table>";
?> 
		...
		<form name="form1" onsubmit="return validateForm(this);" action="admin_pharmacist.php" method="post" >
			...
			<div class = "input-group"	>
				<tr><td align="center"><input name="first_name" class="form-control" type="text" style="width:170px" placeholder="First Name" required="required" id="first_name" /></td></tr>
				<tr><td align="center"><input name="last_name" class="form-control" type="text" style="width:170px" placeholder="Last Name" required="required" id="last_name" /></td></tr>
				<tr><td align="center"><input name="staff_id" class="form-control" type="text" style="width:170px" placeholder="Staff ID" required="required" id="staff_id"/></td></tr>  
				<tr><td align="center"><input name="postal_address" class="form-control" type="text" style="width:170px" placeholder="Address" required="required" id="postal_address" /></td></tr>  
				<tr><td align="center"><input name="phone" class="form-control" type="text" style="width:170px"placeholder="Phone"  required="required" id="phone" /></td></tr>  
				<tr><td align="center"><input name="email" class="form-control" type="email" style="width:170px" placeholder="Email" required="required" id="email" /></td></tr>   
				<tr><td align="center"><input name="username" class="form-control" type="text" style="width:170px" placeholder="Username" required="required" id="username" /></td></tr>
				<tr><td align="center"><input name="password" class="form-control" type="password" style="width:170px" placeholder="Password" required="required" id="password"/></td></tr>
