       ...
       $result = mysql_query("SELECT * FROM manager")or die(mysql_error());
        ...
        while($row = mysql_fetch_array( $result )) {
            ...
            echo "<tbody>";
                ...
                ?>
                <td><a href="update_manager.php?username=<?php echo $row['username']?>"><span class="glyphicon glyphicon-new-window"></span></a></td>
                <td><a href="delete_manager.php?manager_id=<?php echo $row['manager_id']?>"><span class="glyphicon glyphicon-trash"></span></a></td></tr></tbody>
                <?php
         } 
        // close table>
        echo "</table>";
