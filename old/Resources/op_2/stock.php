...
<section class="content">    
		...
		*/
        ...
        echo "<table class='table no-margin'>";
         echo "<thead><tr><th>ID</th><th>Name</th><th>Category</th><th>Description</th><th>Status </th><th>Date Supplied</th><th>Exipry (Days) </th><th>Update </th><th>Delete</th></tr><thead>";
...
?> 
        ...
        <div class="content_2" class="content">
        <h2>Enter New Stock Information</h2>
		 ...
		 <?php echo $message;
            ...
            <div class = "input-group"  >	
                ...
                <tr><td align="center"><input name="expiry" class="form-control" type="date" style="width:170px" placeholder="Unit Cost" required="required" id="expiry" /></td></tr> 
                <tr>
                    <td >
