...
if(isset($_POST['drug_name']))
{
	...
	$sql=mysql_query("INSERT INTO tempPrescri(customer_id,customer_name,age,sex,postal_address,phone,drug_name,strength,dose,quantity)
						VALUES('{$_SESSION['customer_id']}','{$_SESSION['customer_name']}','{$_SESSION['age']}','{$_SESSION['sex']}','{$_SESSION['address']}','{$_SESSION['phone']}','{$drug}','{$strength}','{$dose}','{$quantity}')");
	...
	$file=fopen("receipts/docs/".$_SESSION['customer_id'].".txt", "a+");
