                    ...
                    echo '<table class="table table-striped table-hover">';
                      ...
                      echo "<tbody>";
                        echo "<tr>";
                          ...
                          ?>
                          <td><a href="update_manager.php?manager_id=<?php echo $row['manager_id'];?>"><i class="fas fa-edit"></i></a></td>
                          <td><a href="delete_manager.php?manager_id=<?php echo $row['manager_id'];?>"><i class="fas fa-trash-alt"></i></a></td>
                        </tr>
                      </tbody>
                      <?php
                      }
                    ...
                    echo '<table class="table table-striped table-hover">';
                      ...
                      echo "<tbody>";
                        echo "<tr>";
                          ...
                          echo '<td>' .$row['username']. '</td>';
                          ?>
                          <td><a href="update_pharmacist.php?pharmacist_id=<?php echo $row['pharmacist_id'];?>"><i class="fas fa-edit"></i></a></td>
                          <td><a href="delete_pharmacist.php?pharmacist_id=<?php echo $row['pharmacist_id'];?>"><i class="fas fa-trash-alt"></i></a></td>
                        </tr>
                      </tbody>
                      <?php
                      }
