...
// Retrieve data from database 
			$sql="UPDATE pharmacist SET first_name='$fname', last_name='$lname', postal_address='$postal',phone='$phone',email='$email',username='$username', password='$pas' WHERE username='$username'";
			if($sql>0)
				{
