		 	...
		 	if($result>0)
		 		{
					$message="<font color=blue>sorry the username entered already exists</font>";
		 			...
		 			{
						$sql=mysql_query("INSERT INTO cashier(first_name,last_name,staff_id,postal_address,phone,email,username,password,date)VALUES('$fname','$lname','$staff_id','$postal','$phone','$email','$user','$pas',NOW())");
						if($sql>0)
							{
