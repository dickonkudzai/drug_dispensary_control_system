...
// Retrieve data from database 
			$sql="UPDATE cashier SET first_name='$fname', last_name='$lname', postal_address='$postal',phone='$phone',email='$email',username='$username', password='$pas' WHERE username='$username'";
			if($sql>0)
				{
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    $mid = intval($_GET['cashier_id']);
                    $result = mysql_query("SELECT * FROM cashier where cashier_id = $mid") or die(mysql_error());
                    echo '<table class="table table-striped table-hover">';
                      ...
                      echo "<tbody>";
                        echo "<tr>";
                          echo '<th scope="row">' . $row['cashier_id'] . '</th>';
