      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-uppercase"><span>Drug Dispensary Control System</span><strong class="text-primary">Log In</strong></div>
            <form method="post" id="user-login" class="text-left form-validate">
